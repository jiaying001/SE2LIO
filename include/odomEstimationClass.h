...
class OdomEstimationClass{
	...
	public:
		...
		void addLidarFeature(const pcl::PointCloud<pcl::PointXYZI>::Ptr edge_in, const pcl::PointCloud<pcl::PointXYZI>::Ptr surf_in);
		void optimize(void);
	...
	private:
		...
		pcl::PointCloud<pcl::PointXYZI>::Ptr current_edge_points;
		pcl::PointCloud<pcl::PointXYZI>::Ptr current_surf_points;

		// kdtree for fast indexing
		pcl::KdTreeFLANN<pcl::PointXYZI> edge_kd_tree;
		pcl::KdTreeFLANN<pcl::PointXYZI> surf_kd_tree;
